...
class FloodCategory(Enum):
    ...
    MODEL_600M = '/home/users/li1995/global_flood/FloodRisk-DL/terratorch/output/all-600-major/checkpoints/best-epoch=88.ckpt'
    ...
    MODEL_RES152= '/home/users/li1995/global_flood/FloodRisk-DL/terratorch/output/all-unet-res152/checkpoints/best-epoch=49.ckpt'
