...
class FloodDataset(Dataset):
    def __init__(self, data_dir, split, transform=None, normalize=True, stats_file=None, cache_size=100):
        """
        ...
        self.h5_file = os.path.join(data_dir, self.split + '.h5')
...
class FloodDataModule(pl.LightningDataModule):
    def __init__(self, data_dir, batch_size=16, num_workers=4, normalize=True, stats_file=None, 
    ...
    def setup(self, stage=None):
        ...
        if stage == 'fit' or stage is None:
            ...
            if self.normalize and not self.stats_file:
                self.stats_file = f'normalization_stats.json'
